 function [AZb, ELb, beamid, op_path] = plotPFISR_NeTe_automated_ac_input_2(year,month,day,start_hour,start_min,end_hour,end_min,doyin,hour,hour2,hour3,min1,min2,min3,PRN)
