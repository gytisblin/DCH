function [layer4,layer5,sizeranges_lp,total_data_points_lp,rangesnotnansum_total_lp,nesum_total_lp,rdata_scint_lp,gdlp]=check_data_lp_6(year,month,day,start_hour,start_min,end_hour,end_min,doyin,hour,hour2,hour3,min1,min2,min3,PRN,Madrigal,Madrigalac,alt_cutoff)
layer4=0
layer5=0
if start_hour-1<=0
